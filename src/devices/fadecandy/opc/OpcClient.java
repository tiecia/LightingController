...
public class OpcClient implements AutoCloseable {
	...
	public void removeDevice(OpcDevice device){
	...
	public void changeData(String hostName, int port){
		this.clear();
		this.close();
		this.host = hostName;
		this.port = port;
...
//
//		OpcClient server = new OpcClient(FC_SERVER_HOST, FC_SERVER_PORT, "FC Server");
